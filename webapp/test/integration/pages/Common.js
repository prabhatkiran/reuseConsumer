sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("Sample/reuseConsumer/app", ".html");
		...
		return Opa5.extend("Sample.reuseConsumer.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["Sample/reuseConsumer/localService/mockserver"], function (mockserver) {
