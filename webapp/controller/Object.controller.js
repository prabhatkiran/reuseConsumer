...
sap.ui.define([
	...
	"Sample/reuseConsumer/model/formatter"
], function (
	BaseController,
	JSONModel,
	History,
	...
	return BaseController.extend("Sample.reuseConsumer.controller.Object", {
		...
		_initObjectReusableTable: function () {
			var oComponentContainer = this.byId("objectReusableTabel");
			this.getOwnerComponent().createComponent({
				...
				oComponentContainer.setComponent(oUIComponent);
			});
		}
